...
ETEXI
     ...
     {  
        .name       = "pitt_mtrace",
        .args_type  = "vaddr:i?,begin:i?,end:i?",
        .params     = "[vaddr] [begin] [end]",
        .help       = "Memory Trace Invoker Usage : <pitt_mtrace [app_addr begin_va end_va]>",
        .mhandler.cmd = do_pitt_mtrace,
     },
STEXI
@item memtrace
@findex memtrace
Memory Trace Invoker Usage : <pitt_mtrace [begin_va end_va]>
ETEXI
