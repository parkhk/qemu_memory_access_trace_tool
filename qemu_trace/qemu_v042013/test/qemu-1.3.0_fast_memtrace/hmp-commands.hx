...
ETEXI
     ...
     {  
        .name       = "pitt_mtrace",
        .args_type  = "begin:i?,end:i?,single:s?",
        .params     = "[begin] [end] [on|off]",
        .help       = "Memory Trace Invoker Usage : <pitt_mtrace [begin_va end_va singlestep_on|off]>",
        .mhandler.cmd = do_pitt_mtrace,
     },
STEXI
@item memtrace
@findex memtrace
Memory Trace Invoker Usage : <pitt_mtrace [begin_va end_va singlestep_on|off]>
ETEXI

     {  
        .name       = "trace_file_pitt",
        .args_type  = "name:s",
        .params     = "name",
        .help       = "Change log file name",
        .mhandler.cmd = do_trace_file_pitt,
     },
STEXI
@item memtrace_file
@findex memtrace_file
