...
static inline TranslationBlock *tb_find_fast(CPUArchState *env)
{
	...
	//parkhk
	if(trace_recoding && env->cr[3]  == app_pgd && tb->trace_vaddr < 0x800000000000){
...
#error unsupported target CPU
    ...
    defined(TARGET_MICROBLAZE) || defined(TARGET_LM32) || defined(TARGET_UNICORE32)
                ...
                }else if(trace_recoding && env->cr[3] == app_pgd && tb->trace_vaddr < 0x800000000000){
					//skip last instruction(the inst. was not executed) 
					raw_trace_idx--;
				}
