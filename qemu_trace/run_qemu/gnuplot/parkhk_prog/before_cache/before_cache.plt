...
set pointsize 0.3
set output "read_request_cnt.png"
plot "cpu_read_cnt" using 1:2 ti "Read Request Count"
set output "write_request_cnt.png"
plot "cpu_write_cnt" using 1:2 ti "Write Request Count"
set output "inst_request_cnt.png"
plot "cpu_inst_cnt" using 1:2 ti "Instruction Request Count"
